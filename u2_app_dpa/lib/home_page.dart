...
import 'package:u2_app_dpa/provider/dpa_provider.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('División Político Administrativa'),
              ...
              child: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot snapshot) {
                  ...
                  return DropdownButton<String>(
                    // si la region esta vacia asignale null, si no, asignale el valor de la region
            ...
            Container(
              ...
              child: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot snapshot) {
                  ...
                  return DropdownButton<String>(
                    // si la provincia esta vacia asignale null, si no, asignale el valor de la provincia
